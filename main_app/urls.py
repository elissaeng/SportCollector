...
urlpatterns = [
  ...
  path('sports/<int:sport_id>/add_channel/', views.add_channel, name='add_channel'),
  # path('sports/<int:sport_id>/delete_channel/<int:channel_id/', views.delete_channel, name='delete_channel'),
